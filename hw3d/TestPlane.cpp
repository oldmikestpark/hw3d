...
TestPlane::TestPlane(Graphics& gfx, float size)
{
	...
	AddBind(Texture::Resolve(gfx, "images\\brick_wall_diffuse.jpg"));
	AddBind(Texture::Resolve(gfx, "images\\brick_wall_normal.jpg", 1u));
...
void TestPlane::SpawnControlWindow(Graphics& gfx) noexcept
{
	if (ImGui::Begin("Plane")) 
	{
		...
		bool changed1 = ImGui::SliderFloat("Spec. Pow.", &pmc.specularPower, 0.0f, 100.0f);
